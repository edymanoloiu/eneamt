...
const ContactPage = () => {
	...
	return (
		<>
			<HeadMeta metaTitle="Termeni și Condiții" metaDesc={"Termenii și condițiile de utilizare pentru site-ul eneamt.ro"} />
			<HeaderOne />
				...
				<div className="row">
					<div className="col-lg-8">
						<div className="axil-content">
							...
							<p>
								Site-ul <strong>eneamt.ro</strong> este o publicație online destinată informării publicului prin știri, articole și materiale editoriale. Toate informațiile sunt furnizate în scop informativ.
							</p>
