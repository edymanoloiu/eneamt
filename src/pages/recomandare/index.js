...
const SITE_URL = "https://eneamt.ro";

const RecomandareIndex = ({ postData, allPosts }) => {
	const metaDesc =
		"Articole recomandate și recomandări parteneri pe obliqdesign.ro — conținut editorial selectat.";
	return (
		<>
			<HeadMeta
				metaTitle={`${PAGE_TITLE} | obliqdesign.ro`}
				metaDesc={metaDesc}
